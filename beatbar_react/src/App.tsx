...
export default function App() {
  ...
  function play(startAt: number = 0) {
    if (players && currentSong && pitchNode) {
      ...
      let myPitchNode = new Tone.PitchShift().toDestination()
      pitchNode.pitch = pitch
      // console.log("myPitchNode: ", myPitchNode)
  ...
  function adjustVolume(_volume: number) {
    const _volumeDec: Decibels = _volume as Decibels
    if (players && currentSong) {
      //
    }
    setVolume(_volume)
  ...
  return (
    <div className="app">
      ...
      <div className="bottom-line">
        <div className="developer-options-trigger" onClick={() => {

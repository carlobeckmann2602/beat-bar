...
if (setInputButton) {
  ...
  if (inputUrl) {
    setInputButton.addEventListener('click', () => {
      ...
      postRouteInput.value = "http://localhost:8000/api/post/properties/?song_id=" + fetchUrl.split('/')[3]
      postUrl = "http://localhost:8000/api/post/properties/?song_id=" + fetchUrl.split('/')[3]
